...
function CreateServer(%mission, %missionType)
{
   ...
   // Execute BOL Test scripts
   exec("scripts/modscripts/server/server.cs");
   ...
   exec("scripts/vehicles/vehicle_flanker.cs");
   exec("scripts/vehicles/vehicle_baseseed.cs");
   exec("scripts/vehicles/vehicle_apc.cs");
   exec("scripts/vehicles/vehicle_grizzly.cs");
