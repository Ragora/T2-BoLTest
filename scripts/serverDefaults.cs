...
{
   $Host::GameName = "BOLTest Server";
   $Host::Info = "Server built as a testbed for BoL.";
   $Host::Map = "Katabatic";
   $Host::MaxPlayers = 64;
}
...
$Host::Port = 28000;
$Host::Password = "ChangeMeNow";
$Host::AdminPassword = "ChangeMeNow";
$Host::PureServer = 0;
$Host::Dedicated = 0;
$Host::MissionType = "BOL";
$Host::TimeLimit = 30;
$Host::BotCount = 2;
$Host::BotsEnabled = 0;
