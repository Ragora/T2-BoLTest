datablock AudioProfile(FlankerEngineSound)
{
   filename    = "fx/vehicles/flanker_engine.wav";
   description = AudioDefaultLooping3d;
   preload = true;
};

datablock AudioProfile(FlankerThrustSound)
{
   filename    = "fx/vehicles/flanker_thrust.wav";
   description = AudioDefaultLooping3d;
   preload = true;
};

datablock HoverVehicleData(Flanker) : WildcatDamageProfile
{
   spawnOffset = "0 0 1";
   ...
   targetNameTag = 'Flanker';
   targetTypeTag = 'Scout Vehicle';
